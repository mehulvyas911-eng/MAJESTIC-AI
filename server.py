...
TOOL_COMMANDS = {
    ...
    "hping3": "hping3 {flags} {target}",
    "scapy": "scapy {flags}",
    "zmap": "zmap -p {flags} {target}",
    "arp-scan": "arp-scan {flags} {target}",
    "sslscan": "sslscan {flags} {target}",
    "testssl": "testssl.sh {flags} {target}",
    "ike-scan": "ike-scan {flags} {target}",
    "snmpwalk": "snmpwalk -v {mode} -c public {target}",
    "smbclient": "smbclient -L {target} {flags}",
    "responder": "responder -I eth0 {flags}",
    "mitmproxy": "mitmproxy {flags}",
    "socat": "socat {flags}",
    "proxychains": "proxychains {flags}",
    "bettercap": "bettercap {flags}",
    "aircrack-ng": "aircrack-ng {flags} {target}",
    "wash": "wash -i {target}",
    "reaver": "reaver -i wlan0 -b {target}",
    "sniffglue": "sniffglue {flags}",
    "kismet": "kismet -c {target}",
    "macchanger": "macchanger {flags} {target}",
    "ncat": "ncat {flags} {target}",
    "fping": "fping {flags} {target}",
    "arping": "arping {flags} {target}",
    "tcptraceroute": "tcptraceroute {target}",
    "ip": "ip {flags}",
    "zap": "zaproxy -cmd -quickurl {target}",
    "w3af": "w3af_console {flags}",
    "skipfish": "skipfish -o output {target}",
    "arachni": "arachni {target} {flags}",
    "dirb": "dirb {target} {wordlist}",
    "dalfox": "dalfox url {target} {flags}",
    "xsstrike": "xsstrike -u {target} {flags}",
    "kxss": "echo {target} | kxss",
    "qsreplace": "echo {target} | qsreplace {flags}",
    "httprobe": "echo {target} | httprobe",
    "unfurl": "echo {target} | unfurl {flags}",
    "hakrawler": "echo {target} | hakrawler",
    "aquatone": "cat targets.txt | aquatone {flags}",
    "eyewitness": "eyewitness --web -f {target}",
    "gowitness": "gowitness single {target}",
    "tplmap": "tplmap.py -u {target} {flags}",
    "corsy": "python3 corsy.py -u {target}",
    "blazy": "blazy {target}",
    "jaeles": "jaeles scan -u {target}",
    "dsss": "python3 dsss.py -u {target}",
    "sqliv": "python3 sqliv.py -t {target}",
    "nosqlmap": "python nosqlmap.py -u {target}",
    "jwt_tool": "python3 jwt_tool.py {target}",
    "pwnxss": "pwnxss -u {target}",
    "whatweb": "whatweb {target}",
    "wafw00f": "wafw00f {target}",
    "wappalyzer": "wappalyzer {target}",
    "pacu": "pacu {flags}",
    "scoutsuite": "scout {flags}",
    "cloudsplaining": "cloudsplaining scan {flags}",
    "cloudsploit": "cloudsploit scan {flags}",
    "prowler": "prowler {flags}",
    "kube-hunter": "kube-hunter {flags}",
    "kube-bench": "kube-bench {flags}",
    "awscli": "aws {flags}",
    "azure-cli": "az {flags}",
    "gcloud": "gcloud {flags}",
    "s3scanner": "s3scanner {flags} {target}",
    "cloudbrute": "cloudbrute -d {target}",
    "trufflehog": "trufflehog {flags} {target}",
    "gitleaks": "gitleaks detect -v",
    "gitrob": "gitrob {target}",
    "shhgit": "shhgit {flags}",
    "aws-vault": "aws-vault {flags}",
    "awspx": "awspx {flags}",
    "endoflife": "endoflife {target}",
    "ccscanner": "ccscanner {target}",
    "gdb": "gdb {target} {flags}",
    "radare2": "r2 {target} {flags}",
    "ghidra": "ghidra {flags}",
    "ida": "ida {target}",
    "objdump": "objdump -d {target}",
    "ltrace": "ltrace {target}",
    "strace": "strace {target}",
    "hexdump": "hexdump -C {target}",
    "xxd": "xxd {target}",
    "readelf": "readelf -a {target}",
    "nm": "nm {target}",
    "patchelf": "patchelf {flags} {target}",
    "ldd": "ldd {target}",
    "gcore": "gcore {target}",
    "upx": "upx -d {target}",
    "apktool": "apktool d {target}",
    "dex2jar": "d2j-dex2jar {target}",
    "jadx": "jadx {target}",
    "smali": "smali a {target}",
    "baksmali": "baksmali d {target}",
    "c_filt": "c++filt {flags}",
    "cyberchef": "cyberchef {flags}",
    "base64": "echo {target} | base64 -d",
    "rot13": "echo {target} | tr 'A-Za-z' 'N-ZA-Mn-za-m'",
    "rsa_tool": "rsa_tool {flags}",
    "yafu": "yafu {flags}",
    "z3": "z3 {target}",
    "angr": "python angr_script.py {target}",
    "pwntools": "python pwn_script.py {target}",
    "foremost": "foremost -i {target}",
    "scalpel": "scalpel -c scalpel.conf {target}",
    "autopsy": "autopsy {target}",
    "dumpit": "dumpit {flags}",
    "winpmem": "winpmem {flags}",
    "testdisk": "testdisk {target}",
    "photorec": "photorec {target}",
    "pngcheck": "pngcheck {target}",
    "outguess": "outguess -r {target} {flags}",
    "pdfcrack": "pdfcrack -f {target}",
    "fcrackzip": "fcrackzip -u -c a -p {wordlist} {target}",
    "johntheripper": "john {target} --wordlist={wordlist}",
    "recon-ng": "recon-ng {flags}",
    "maltego": "maltego {flags}",
    "spiderfoot": "spiderfoot -s {target}",
    "certspotter": "curl -s https://api.certspotter.com/v1/issuances?domain={target}",
    "censys": "censys search {target}",
    "zoomeye": "zoomeye search {target}",
    "fofa": "fofa search {target}",
    "intelx": "intelx -search {target}",
    "namechk": "namechk {target}",
    "sherlock": "sherlock {target}",
    "twint": "twint -u {target}",
    "instaloader": "instaloader {target}",
    "holehe": "holehe {target}",
    "phoneinfoga": "phoneinfoga scan -n {target}",
    "metagoofil": "metagoofil -d {target} -t pdf,doc,xls",
    "amass-intel": "amass intel -d {target}",
    "dnsdumpster": "python dnsdumpster.py -d {target}",
    "crtsh": "curl -s https://crt.sh/?q={target}&output=json",
    "shodan-cli": "shodan search {target}",
    "snusbase": "snusbase {target}",
    "arp-scan":       "arp-scan {flags} {target}",
